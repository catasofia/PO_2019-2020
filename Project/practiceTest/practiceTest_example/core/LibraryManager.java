...
public class LibraryManager implements Serializable {
  ...
  public String performSearchRequest(int iDObra) {
    return _library.performSearchRequest(iDObra);
  }

  public String pesquisaUser(String term) {
    return _library.pesquisaUser(term);
  }
  ...
  public int requestWork(int userId, int workId)
      throws NoSuchUserIdException, NoSuchWorkIdException, RulesFailedException {
